The repository TEI-2-SC contains transformations from TEI files to Shared Canvas manifests in JSON-LD, the XSL code is created in the scope of the Biblissima project.
